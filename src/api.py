...
from src.routers import projects, elements, diagrams, ai_activity, agents, websockets
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*", "http://localhost:5173", "http://localhost:5174", "http://192.168.1.93:5173", "http://192.168.1.93:5174"],
